    ...
    <div className="flex justify-center">
      <div className="mt-20 ml-6">
        ...
        <div className="flex justify-around mt-10">
          <div className="w-[325px] h-[480px] p-[40px] border-[1px] border-gray-200 shadow-xl rounded-3xl mr-10">
            <Image
              src="/product.webp"
              alt="product"
              width={300}
            ...
            <Link href="/product" className="hover:text-blue-800">
              <h1 className="text-2xl font-bold mt-4">
                Identify the best technologies for your business with
                Tecnologia’s new tool
              </h1>
          ...
          <div className="w-[325px] h-[480px] p-[40px] border-[1px] border-gray-200 shadow-xl rounded-3xl">
            ...
            <Link href="/product" className="hover:text-blue-800">
              <h1 className="text-2xl font-bold mt-4">
                Clutch Recognizes Tecnologia Among New York’s Top Development
                for 2023
              </h1>
